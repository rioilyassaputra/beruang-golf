			...
			<div class="container py-lg-5">
					<div class="welcome-grids row">
						<div class="col-lg-6 mb-lg-0 mb-5">
                            <h3 class="title-style text-center mb-2 pl-4">{{ $paket->nama }}</h3>
                            <b class="mt-3">Lapangan</b> <br>
                            <p >
                                {{$paket->lapangan->nama}} <br>
                                <p >
                                    <b>Jumlah Pemain</b><br>
                                    {{$paket->jumlah_pemain}}<br>
                                </p>
                                <b>jam oprasional</b><br>
                                <p>

                                    {{\Carbon\Carbon::createFromFormat('H:i:s',$paket->jam_mulai)->format('h:i')}} -
                                    {{\Carbon\Carbon::createFromFormat('H:i:s',$paket->jam_selesai)->format('h:i')}}
                                </p>
                                <b>Harga</b><br>
                                Rp.{{number_format($paket->harga,0,',','.')}} <br>
                                <br>
                                <b class="mt-3">deskripsi Paket</b>
                                {!!str_replace("&Amp;Nbsp;", " ", $paket->deskripsi)!!} <br>
						</div>
						<div class="col-lg-5 welcome-image">
                            <img
                                src="{{url('/admin/paket/' . @$paket->gambar)}}"
