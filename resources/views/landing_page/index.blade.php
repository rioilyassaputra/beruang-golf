...
<html lang="en">
  ...
  <body>
      ...
      <div class="hero-header-11">
        <div id="wrapper">
          <section class="slideshow" id="js-header">
            ...
            <div
              class="slideshow__slide js-slider-home-slide is-prev"
              data-slide="3"
            >
              <div
                class="slideshow__slide-background-parallax background-absolute js-parallax"
    ...
    <!-- banner slider -->
    <script src="landing_page/assets/js/slideshow-slider.js"></script>
    <!-- //banner slider -->

    <!-- counter for stats -->
    <script src="landing_page/assets/js/counter.js"></script>
    <!-- //counter for stats -->
