                ...
                <div class="main-hotair">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="#" method="post">
                            <input type="text" class="text" name="text" placeholder="Masukkan Nama" required="" autofocus>
                            <input type="email" class="email" name="email" placeholder="Masukkan Email" required="" autofocus>
                            <input type="password" class="password" name="password" placeholder="Masukkan Password" required="" autofocus>
                            <button class="btn" type="submit">Log In</button>
                        </form>

                        <p class="account">Sudah Punya Akun? <a href="/user/login">Masuk</a></p>
                    </div>
